...
def main():
    ...
    options.set_chart_title("Number of days between the last submission and the deadline for all homework")
    options.set_height(500)
    options.set_width(1200)
    options.set_page_title("Number of days between the last submission and the deadline for all homework")
    ...
    options.set_output_file("./output/days_last_submission_before_deadline_homework.html")
