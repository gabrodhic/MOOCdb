...
def main():
    '''
    This function plots the distribution of the days between the last submission and the deadline the midterm"
    '''    
    ...
    SELECT 
         ...
         COUNT(*) AS `Number of days between the last submission and the deadline for the midterm`
    ...
    WHERE submissions.submission_attempt_number = ( -- We just want the last attempt
        ...
        AND problems.problem_type_id = 5 -- = 5 means Midterm exam
     GROUP BY day
     ORDER BY day ASC 
    ;
    ;
    ...
    options.set_chart_title("Number of days between the last submission and the deadline for the midterm")
    options.set_height(500)
    options.set_width(1200)
    options.set_page_title("Number of days between the last submission and the deadline for the midterm")
    ...
    options.set_output_file("./output/days_last_submission_before_deadline_midterm.html")
