...
def main():
    ...
    FROM 
        ...
        WHERE number_of_events_per_user.`Number of observed events` < 50
    ...
    options.set_page_title("Number of students per number of observed events - Cutoff 50")
    ...
    options.set_output_file("./output/number_of_users_per_number_of_observed_events_cutoff50.html")
