...
def main():
    ...
    options.set_chart_title("Number observed events per submission by country having at least 200 students")
    options.set_height(600)
    options.set_width(1000)
    options.set_page_title("Number observed events per submission by country having at least 200 students")
    options.set_output_file("./output/observed_events_per_submission_by_country_cutoff200students.html")
